...
class PurchaseApplicationServiceTest {
    ...
    @Test
    @DisplayName("Should throw InsufficientStockException when result would be zero")
    void shouldThrowInsufficientStockExceptionWhenResultWouldBeZero() {
        // Given
        Long productId = 1L;
        int requestedQuantity = 100; // Exactly the available quantity
